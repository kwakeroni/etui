...
public class MatchingAssert extends AbstractCollectionAssert<MatchingAssert, Collection<? extends Match>, Match, MatchAssert.MatchWithExpressionAssert> {
    private final Expression expression;
    private final String fullString;

    public MatchingAssert(Expression expression, String fullString, Collection<? extends Match> matches) {
    ...
    @Override
    protected MatchAssert.MatchWithExpressionAssert toAssert(Match value, String description) {
        var matchAssert = new MatchAssert.MatchWithExpressionAssert(value, expression);
        return (description == null) ? matchAssert : matchAssert.describedAs(description);
    }

    public MatchingAssert assertAll(Consumer<MatchAssert.MatchWithExpressionAssert> assertConsumer) {
        return allSatisfy(match -> assertWith(assertConsumer, match));
    }

    @SafeVarargs
    @SuppressWarnings("RedundantCast")
    public final MatchingAssert assertExactlyInAnyOrder(Consumer<MatchAssert.MatchWithExpressionAssert>... assertConsumers) {
    ...
    private void assertWith(Consumer<MatchAssert.MatchWithExpressionAssert> assertConsumer, Match match) {
